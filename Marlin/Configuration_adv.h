...
#define FWRETRACT
  ...
  #define RETRACT_RECOVER_LENGTH_SWAP   0.05 // (mm) Default additional swap recover length (added to retract length on recover from toolchange)
 ...
 */
  ...
  // TODO: These used to default to these values, but now they default to the SW SPI pins even if the above is commented
  //       Also, I think I need to use SW SPI in order to use the SD card reader via HW SPI
  #define TMC_SPI_MOSI  MOSI
  #define TMC_SPI_MISO  MISO
  #define TMC_SPI_SCK   SCK
