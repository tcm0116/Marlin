...
#define STRING_CONFIG_H_AUTHOR "(T. Moore, 3DP-11 Chimera)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3DP-11 Chimera"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // HICTOP 3DP-11 - Chimera
  #define  DEFAULT_Kp 44.98
  #define  DEFAULT_Ki 4.10
  #define  DEFAULT_Kd 123.38
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 717.21, 730.76 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 160, 160, 5, 40, 40 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION -X_PROBE_OFFSET_FROM_EXTRUDER - X_MIN_POS
  #define RIGHT_PROBE_BED_POSITION (X_MAX_POS + X_PROBE_OFFSET_FROM_EXTRUDER)
  #define FRONT_PROBE_BED_POSITION Y_PROBE_OFFSET_FROM_EXTRUDER + 10
