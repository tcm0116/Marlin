...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  //#define  DEFAULT_Ki 5.36
  //#define  DEFAULT_Kd 51.95

  // Kossel Pro with insulated heater
  #define  DEFAULT_Kp 14.95
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 97.0 // mm
  ...
  // #define DELTA_DIAGONAL_ROD 339.94// mm ORIGINAL BEFORE CHANGE
  #define DELTA_DIAGONAL_ROD 338.0 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 350.0 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal offset from middle of printer to smooth rod center.
  // #define DELTA_SMOOTH_ROD_OFFSET 214.5 // mm ORIGINAL BEFORE CHANGE
  #define DELTA_SMOOTH_ROD_OFFSET 206.5 // mm

  // Horizontal offset of the universal joints on the end effector.
  //#define DELTA_EFFECTOR_OFFSET 29.15 // mm ORIGINAL BEFORE CHANGE
  #define DELTA_EFFECTOR_OFFSET 26.1 // mm

  // Horizontal offset of the universal joints on the carriages.
  //#define DELTA_CARRIAGE_OFFSET 20.0 // mm ORIGINAL BEFORE CHANGE
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 406.3 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 400, 400, 400, 3000 }
...
#define DEFAULT_ZJERK                 12.0 // Must be same as XY for delta
...
//#define PREHEAT_1_FAN_SPEED   255 // Value from 0 to 255 - for stock BIQU

#define PREHEAT_2_TEMP_HOTEND 230
#define PREHEAT_2_TEMP_BED    100
#define PREHEAT_2_FAN_SPEED     0 // Value from 0 to 255
//#define PREHEAT_2_FAN_SPEED   255 // Value from 0 to 255 - for stock BIQU
