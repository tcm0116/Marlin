...
#define STRING_CONFIG_H_AUTHOR "(T. Moore, 3DP-11 Aero)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3DP-11 Aero"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 439.77 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 160, 160, 20, 50 }
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER   2.43328  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER -43.69602  // Y offset: -front +behind [the nozzle]
